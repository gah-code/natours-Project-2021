...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2lsYmVydDk0IiwiYSI6ImNrczU2a25rYzE0ZW8ydW10aHJtMTBhaTMifQ.kkal20q4d3Xm2IKTVhi-sA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/gilbert94/cks56xovq3sil17p5wg97cbti',
    scrollZoom: false // center: [-121.6543901, 37.1305012],
    // interactive: false,
    // zoom: 10,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend the map bounds to include current locaton
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JQKL2LzZVy0JbkeIJWN6lDDlwljAuehsMh624ZkZMFvps7w2y0dHQwATC5Wi3d25r9py5b86J45j6rTiS9VzPBs00gnGa9VmF');
            _context.prev = 1;
            _context.next = 4;
